  ...
  return (
    <footer>
      <div className="info-segment">
        {/* Photo */}
        <Squircle
          className="photo-dave"
          cornerRadius={42}
          borderWidth={1.5}
          cornerSmoothing={0.8}>
          <Squircle cornerRadius={38} cornerSmoothing={0.8}>
            <img
              src={dave}
        ...
        <div className="text-and-btn">
          ...
          {/* Button */}
          {/* maybe TODO: add Squircle, inside or outside of button */}
      ...
      <div className="hero-detail">
        <p>Software +</p>
        <img src={Biology} alt="Biology" width="100" />
      </div>
    </footer>
  );
}
